...
if "person" in st.session_state:
    ...
    def cbc_advice(hb_result, wbc_result, plt_result):
        ...
        if hb_result == "ปกติ" and wbc_result == "ปกติ" and plt_result == "ปกติ":
            return ""
        if hb_result == "พบภาวะโลหิตจาง" and wbc_result == "ปกติ" and plt_result == "ปกติ":
            return cbc_messages[8]
        if hb_result == "พบภาวะโลหิตจาง" and wbc_result in ["ต่ำกว่าเกณฑ์", "ต่ำกว่าเกณฑ์เล็กน้อย", "สูงกว่าเกณฑ์เล็กน้อย", "สูงกว่าเกณฑ์"]:
            return cbc_messages[9]
        if hb_result == "พบภาวะโลหิตจางเล็กน้อย" and wbc_result == "ปกติ" and plt_result == "ปกติ":
            return cbc_messages[2]
        if hb_result == "ปกติ" and wbc_result in ["ต่ำกว่าเกณฑ์", "ต่ำกว่าเกณฑ์เล็กน้อย", "สูงกว่าเกณฑ์เล็กน้อย", "สูงกว่าเกณฑ์"]:
            return cbc_messages[6]
        if plt_result == "สูงกว่าเกณฑ์":
            return cbc_messages[10]
        if hb_result == "พบภาวะโลหิตจางเล็กน้อย" and wbc_result in ["ต่ำกว่าเกณฑ์", "ต่ำกว่าเกณฑ์เล็กน้อย", "สูงกว่าเกณฑ์เล็กน้อย", "สูงกว่าเกณฑ์"] and plt_result == "ปกติ":
